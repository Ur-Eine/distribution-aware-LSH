...
public:
	...
	void improvedSearchWithKth(DataMetric& highData, DataMetric& highQueryData, DataMetric& lowQueryData, DataMetric& lowData2, DataMetric& lowQueryData2, Real_Result& real_result);
