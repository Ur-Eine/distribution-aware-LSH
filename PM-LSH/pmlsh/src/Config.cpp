...
//ours
string Config::trainedWFile = "None"; // None 用于标识不从外部导入投影矩阵
bool Config::updateDist = false;
string Config::sampledParaFile = "None";
bool Config::autoT = false;